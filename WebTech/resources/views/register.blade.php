            ...
            <article class="jumbotron">
                ...
                <form action="">
                    ...
                    <section class="form-group">
                        ...
                        <input id="firstname" class="form-control" type="text" placeholder="Janko" required>
                    </section>
                    

                    <section class="form-group">
                        <label for="surname">Priezvisko:</label>
                        <input id="surname" class="form-control" type="text" placeholder="Hraško" required>
                    </section>
                    

                    <section class="form-group">
                        <label for="password">Heslo:</label>
                        <input id="password" class="form-control" type="password" placeholder="Heslo musí mať aspoň 8 znakov" required>
                    </section>
            
                    <section class="form-group">
                        <label for="password2">Potvrdiť Heslo:</label>
                        <input id="password2" class="form-control" type="password" placeholder="Heslá sa musia zhodovať" required>
                    </section>
                    
                    <section class="form-group">
                        <label for="phone">Telefón:</label>
                        <input id="phone" class="form-control" type="text" placeholder="+XXX XXX XXX XXX" required>
                    </section>
                
                    <section class="form-group">
                        <label for="email">Email:</label>
                        <input id="email" class="form-control" type="email" value="@" required>
                    </section>
                    ...
                    <section class="text-center">
                        <input class="btn btn-info btn-lg" type="submit" value="Registrovať">
                    </section>
                </form>
            </article>
        </article>
