...
<section class="container">
	...
	<article>
		...
		@foreach($produkty as $prod)
		 @if ($loop->index==3)
		 <section class="col-lg-3 d-md-none col-sm-6 col-xs-12 mb-3 d-lg-flex d-flex align-items-stretch">
			...
			@endif
				<div id="karticka" class="card h-100 w-100">
					...
					<div class="card-body text-center">
						...
						<a href="/allproducts/{{strtolower($prod->sex)}}/{{$prod->category}}/{{$prod->id}}" class="stretched-link">
							<h5 >
