            ...
            <article class="jumbotron">
                ...
                <form action="">
                    ...
                    <section class="form-group">
                        ...
                        <input id="emailField" type="email" class="form-control" value="@" required>
                    </section>
                    

                    <section class="form-group">
                        <label for="passwordField">Heslo:</label>
                        <input id="passwordField" type="password" class="form-control" placeholder="******" required>
                    </section>
                    ...
                    <section class="text-center">
                        <a href="homepage.html" class = "btn btn-info btn-lg" role="button">Prihlásiť sa</a>
                    </section>
                ...
                <section class="text-center">
                    ...
                    <a href="register.html" class = "btn btn-info btn-lg" role="button">Registrovať</a>
                </section>
            </article>
</article>
