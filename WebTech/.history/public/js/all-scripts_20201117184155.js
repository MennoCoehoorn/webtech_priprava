...
function showSearch(){
	...
	if (state==="none"){
		...
		document.querySelector('#searchBtn').display="inline-block";
		...
		document.querySelector('#searchBtn').display="none";
...
function showSearchPop(){
	...
	if (state==="none"){
		...
		document.querySelector('#searchBtn2').display="inline-block";
		...
		document.querySelector('#searchBtn2').display="none";
