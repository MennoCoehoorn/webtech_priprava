...
function check_stock(stock){
	...
	var color=document.querySelector('.dropdown-menu >li >input[type="radio"]:checked')
	var in_stock=false;
	if (size!=null && color!=null){
		for (var i=0; i<stock.length; i++){
			if (size.value==stock[i][color_code] && color.value==stock[i][size_name]){
...
function filter_to_query(curr_url){
