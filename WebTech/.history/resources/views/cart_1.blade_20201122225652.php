...
<div class="container">
	...
	@endif
                        ...
                        <section class="row cart_item">
                                ...
                                <ul>
                                    ...
                                    <li> 
                                        <form action="/quantupdate" method="POST">
                                            ...
                                            <input type="number" name="quant" value="{{$entry->quantity}}" min="1" max="{{$entry->max_count}}" step="1">
                            ...
                            <section class="product_part col-md-1">
                                <form action="{{url('cart1', [$entry->sub_id])}}" method="POST">
                                    ...
                                    <input type="submit" class="btn btn-secondary btn-sm float-md-none float-right remove_btn" value="X"/>
                                </form>
                            </section>
            ...
            <section class="bottom_buttons">
                <a href="/landing" class="btn btn-secondary bt-lg" role="button">Späť</a>
