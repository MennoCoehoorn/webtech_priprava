			...
			<section class="col-12 col-md-4 product-sel">
				...
				<div class="row">
					...
					<li>
							...
							class="hidden-radio" type="radio" name="color" onclick='color_picked(<?php echo $stock ?>)'>
				...
				<form action="{{ route('cart.add',[ 'id'=>$product->id,
													...
													'color'=>Request::get('color')]) }}" method="POST">
                    <button class="btn-info cart_add" disabled>Vyberte veľkosť a farbu</button>
                </form>
