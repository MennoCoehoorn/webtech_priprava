...
@endsection
	...
	@endif
		<section>
			<div class="row">
				<a href="{{url()->previous()}}"><span class="fa fa-arrow-left"></span> Návrat na predošlú obrazovku</a>
			</div>
		...
		<section class="row">
			<section class="col-md-8 col-12">
				<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						@endif	
						<picture>
    						<source srcset="/{{$pic->picture_path['picture_path_xlg']}}"
								media="(min-width: 1200px)">
							<source srcset="/{{$pic->picture_path['picture_path_lg']}}"
            					media="(min-width: 992px)">
            				<source srcset="/{{$pic->picture_path['picture_path_md']}}"
            					media="(min-width: 768px)">
            				<source srcset="/{{$pic->picture_path['picture_path_s']}}"
            					media="(min-width: 576px)">
            				<source srcset="/{{$pic->picture_path['picture_path_xs']}}"
            					media="(max-width: 575px)">


   					 		<img src="/{{$pic->picture_path['picture_path_md']}}" width=100%  />
			...
			<section class="col-12 col-md-4 product-sel">
				...
				<div class="row">
					...
					<input class="quantity_input" id="input" type="number" min="1" max="1" value="1" onchange="quantity_change()">
				...
				<form action="/addtocart" method="POST"> 
					...
					<input type="hidden" name="sizeHidden" value="">
					<input type="hidden" name="colorHidden" value="">
					<input type="hidden" name="quantityHidden" value="1">
                    <button type="submit" class="btn-info cart_add" disabled=true >Vyberte veľkosť a farbu</button>
                </form>
		...
		<section class="description-tabs mt-30">
