...
<nav class="navbar navbar-inverse fixed-top align-items-start">
	 	...
	 	<section class="navbar-nav navbar-right">
			...
			<div id="searchPop" class="row d-block d-sm-none">
			 	<form action="/search" method="GET">
					 @csrf
	 			<input class="col" id="searchInput2" type="input" name="query" id="search" placeholder="Hľadajte..." />
				<button class="col" id="searchBtn2"class="btn-primary" type="submit"><span class="fa fa-arrow-right"></span></button>
					</form>
	 		</div>
