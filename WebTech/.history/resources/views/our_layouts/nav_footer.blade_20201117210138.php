	 	...
	 	<section class="navbar-nav navbar-right">
	 		<div class="row justify-content-end">
	 			<div class="col d-none d-sm-inline-block">
					 ...
					 @csrf
	 				<input class="col-8" id="searchInput" type="input" id="search" name="query" placeholder="Hľadajte..." />
					 <button class="btn-info col-4" id="searchBtn"class="btn-primary" type="submit">Hľadať</button>
					</form>
	 			</div>
