	 	...
	 	<section class="navbar-nav navbar-right">
			 ...
			 @csrf
	 			...
	 			<div class="col-xs-10">
	 				...
	 				<button type="submit" id="searchIcon" onclick="showSearchPop()" class="header-icon d-inline-block d-sm-none" 
	 					>
	 					<span class="fa fa-search" aria-hidden="true"></span>
	 				</button>

	 				<button type="submit" id="searchIcon" onclick="showSearch()" class="header-icon d-none d-sm-inline-block" 
	 					>
	 					<span class="fa fa-search" aria-hidden="true"></span>
	 				</button>
