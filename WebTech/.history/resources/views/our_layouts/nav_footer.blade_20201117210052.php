	 	...
	 	<section class="navbar-nav navbar-right">
	 		<div class="row justify-content-end">
	 			<div class="col d-none d-sm-inline-block">
					 ...
					 @csrf
	 				<input class="col" id="searchInput" type="input" id="search" name="query" placeholder="Hľadajte..." />
					 <button class="col" id="searchBtn"class="btn-primary" type="submit">Hľadať</button>
					</form>
	 			</div>
