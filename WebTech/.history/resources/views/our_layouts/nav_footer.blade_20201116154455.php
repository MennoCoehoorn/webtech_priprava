	 	...
	 	<section class="navbar-nav navbar-right">
	 		<div class="row justify-content-end">
	 			<div class="col d-none d-sm-inline-block">
					 ...
					 @csrf
	 				<input id="searchInput" type="search" id="search" name="query" placeholder="Hľadajte..." />
					 <button id="searchBtn"class="btn-primary" type="submit" hidden>Hľadať</button>
					</form>
	 			</div>
	 		...
	 		<div id="searchPop" class="row d-block d-sm-none">
				...
				<button id="searchBtn2"class="btn-primary" type="submit" hidden>Hľadať</button>
					</form>
	 		</div>
		</section>
