						...
						{{$book->price}}€
							...
							<h5 >
								<a href="{{route('productdetail', ['gender' => $book->sex,
																...
																'id'=> $book->product_id])}}" class="stretched-link">
	...
	@endforeach
 			...
 			<section class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-3 d-flex align-items-stretch">
				<div class="card ">
					...
					<div class="view overlay">
						<picture>
    						<source srcset="red-dress-250.jpg"
            					media="(min-width: 1200px)">
            				<source srcset="red-dress-200.jpg"
            					media="(min-width: 768px)">
            				<source srcset="red-dress-250.jpg"
            					media="(min-width: 567px)">
            				<source srcset="red-dress-500.jpg"
            					media="(min-width: 401px)">
            				<source srcset="red-dress-250.jpg"
            					media="(max-width: 400px)">
   					 		<img src="/red-dress-500.jpg" width=100% alt="foto šiat" />
						</picture>
 		...
 		<section class="row">
 			<div class="col load-more">
				{{$produkty->withPath('/allproducts/f/šaty')->withQueryString()->links()}}
