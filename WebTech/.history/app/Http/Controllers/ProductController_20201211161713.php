...
class ProductController extends Controller
{
    ...
    public function search(){
        ...
        $allcolors=Color::select('color_name')->join('products_sizes_colors','products.id','=','products_sizes_colors.product_id')
        ->join('colors','products_sizes_colors.color_id','=','colors.id')
        ->where([['products.name','like', '%'.$searchtext.'%']])
        ->orWhere([['products.description','like', '%'.$searchtext.'%']])->get();
