...
class ProductController extends Controller
{
    function pictures($p_path){
                ...
                if(strpos($p_path,".png")!= false){
                    ...
                    $img->resize(240, 400, function ($constraint) {
                        $constraint->aspectRatio();
                        
                    });
                    $img->resizeCanvas(240, 400, 'center', false, array(255, 255, 255, 0));
                    ...
                    $img->resizeCanvas(240, 400, 'center', false, array(255, 255, 255, 100));
