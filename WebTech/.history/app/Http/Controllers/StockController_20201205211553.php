...
class StockController extends Controller
{
    ...
    public function edit(ProductSizeColor $product)
    {
        return response()->json($product);
    }

    public function update(Request $request, ProductSizeColor $product)
    {
        ...
        */
        ...
        $stock->collection=$request->collection;
        $stock->sex=$request->sex;
        $stock->save();
    }
    ...
    public function list($page) {  
        ...
        if ($rowsPerPage == 0) {
            ...
            $products = DB::table('products_sizes_colors')
                ->join('products','products.id','products_sizes_colors.product_id')
                ->join('sizes','sizes.id','products_sizes_colors.size_id')
