...
class ProductController extends Controller
{
    ...
    public function search(){
        ...
        ->join('products_sizes_colors','products.id','=',$prod->product_id)
        ->join('colors','products_sizes_colors.color_id','=','colors.id')->get();
        $prod->col=$colors->col;
        }
...
*/
    ...
    public function show($gender,$category,$id){
        ...
        foreach($product as $prod){
            $prod->picture_path=$this->pictures_carousel($prod->picture_path);
            $colors=Product::select(DB::raw('GROUP_CONCAT(colors.color_code) as col'))
        ->join('products_sizes_colors','products.id','=',$prod->product_id)
        ->join('colors','products_sizes_colors.color_id','=','colors.id')->get();
        $prod->col=$colors->col;
